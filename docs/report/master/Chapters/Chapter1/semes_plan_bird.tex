...
In addition to the day to day booking, we will be designing the user interface for a semester planning system. We will try to assist the administration in utilizing the rooms to the maximum potential by taking as many relevant factors in to consideration as possible. At the point when a semester needs to be planned, most courses only have a start-week and an end-week, along with the number of enrolled students. Some courses can, eg. due to external teachers with busy schedules, have narrowed down their options, and we must of course including support for these scenarios.
