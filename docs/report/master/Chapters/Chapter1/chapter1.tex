...
% -- Skal ind i rapporten:
% Current situation indeholder mange interessante oplysninger.
% Der savnes dog et overblik over ressourcerne: de forskellige typer
% lokaler (mødelokaler, undervisningslokaler, kontorer -- hvoraf de
% sidste er uden for scope her).
