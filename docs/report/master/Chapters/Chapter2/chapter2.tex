...
Throughout the project, we encountered some very domain specific challenges, that ultimately should be answered by ITU. They are nevertheless important to our application and will thus be discussed in this section.
